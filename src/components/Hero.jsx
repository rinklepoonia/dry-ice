...
function Hero() {
    ...
    return (
      <div className="hero_bg_img min_vh_heroSection d_flex flex-column pb_100">
        <div className="container">
          <div className="d-lg-flex justify-content-between py_14 mx_45 gap-4 overflow-x-auto d-none">
            ...
            >
              ...
              <p className="ff_acmin fw-normal text16_xs lh_24 color_white opacity_70 mb-0 text-nowrap info_hover transition">
          ...
          <div className="nav_property d-flex justify-content-between align-items-center mt-lg-0 mt-3">
            ...
            <ul
              className={`${
                nav ? "end-0" : "right_100"
              } mobile_view d-flex gap_24 ps-0 mb-0`}
            >
              <li>
                <a
                  href="#home"
                  onClick={() => setnav(!nav)}
                  className="ff_acmin fw-bold text16_xs lh_19 color_grey text-nowrap nav_hover transition"
                >
                  Home
                </a>
              </li>
              ...
              <li>
                <button className="ff_acmin fw-bold text16_xs lh_19 color_white btn_property d-md-none d-block">
                  Call Us
                </button>
              </li>
            </ul>
            <button className="ff_acmin fw-bold text16_xs lh_19 color_white btn_property d-md-block d-none btn_hover transition">
              Call Us
            </button>
        ...
        <div
          data-aos="zoom-in"
          id="home"
          className="d-flex flex-column flex_grow_1"
        >
          <div className="container">
            <div className="pt_md_87 pt_35 d-flex flex-column align-items-center">
              <h1 className="ff_titling fw-bold text96_3xl lh_lg_115 lh_md_90 lh_65 color_white max_w_730 text-center mb-md-3 mb-1">
                Automotive Dry <span className="d-lg-block">Ice Cleaning</span>
              </h1>
              <p className="ff_acmin fw-normal text20_md lh_30 color_white max_w_730 text-center mb-md-4 mb-0 pb-lg-3 pb-0">
              ...
              <div className="d-flex flex-wrap align-items-center justify-content-center gap_28 mt_md_40 mt_20 no_box">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <p className="ff_acmin fw-bold text16_xs lh_24 color_white mb-0">
                    Non-Abrasive
                  </p>
                </div>
                <div className="d-flex align-items-center gap-3">
