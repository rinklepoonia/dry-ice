            ...
            <div className="container">
                <div className="row flex-lg-row flex-column-reverse">
                    <div data-aos="fade-right" className="col-lg-6 pt-lg-0 pt-4">
                        <h2 className='ff_titling fw-bold text48_2xl lh_lg_57 lh_39 color_blue max_w_351 mb-lg-2 mb-1'>The Future of<span className='d-lg-block'> Car Cleaning</span></h2>
                        ...
                        <div className='d-flex align-items-start gap-3 mb-md-3 mb-2'>
                            ...
                            <div className='blank'>
                                <p className='ff_acmin fw-bold text16_xs lh_24 color_blue mb-md-1 mb-0'>Gentle Yet Powerful</p>
                        ...
                        <div className='d-flex align-items-start gap-3 mb-md-3 mb-2'>
                            <img src={tiksvg} alt="tiksvg" />
                            <div className='blank'>
                                <p className='ff_acmin fw-bold text16_xs lh_24 color_blue mb-md-1 mb-0'>Precision Cleaning</p>
                        ...
                        <div className='d-flex align-items-start gap-3 mb-md-3 mb-2'>
                            <img src={tiksvg} alt="tiksvg" />
                            <div className='blank'>
                                <p className='ff_acmin fw-bold text16_xs lh_24 color_blue mb-md-1 mb-0'>Safe for AlI Vehicles</p>
                        ...
                        <div className='d-flex align-items-start gap-3 mb-md-3 mb-0 pb-lg-0 pb-sm-4 pb-3'>
                            <img src={tiksvg} alt="tiksvg" />
                            <div className='blank'>
                                <p className='ff_acmin fw-bold text16_xs lh_24 color_blue mb-md-1 mb-0'>Eco-Friendly Approach</p>
                ...
                <div>
                    ...
                    <div className='mx-auto text-center max_w_172 mb-3'>
                        <button className='ff_acmin fw-bold text16_xs lh_19 color_white btn_property btn_hover transition text-center'>Get Instant Quote</button>
                    </div>
